...
public class CreateSpecialist {
    ...
    private static final SpecializationsHandler SPECIALIZATION_HANDLER = new SpecializationsHandler();
    private static final SpecialistsHandler SPECIALIST_HANDLER = new SpecialistsHandler();
    ...
    private void createGui() {
        JFrame frame = new JFrame("Create Specialist");
        ...
        btnConfirm.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                if (!txtName.getText().isEmpty() && !txtSurname.getText().isEmpty() && !txtTitle.getText().isEmpty()) {
                    Specialist SP = new Specialist(txtName.getText(), txtSurname.getText(), txtTitle.getText(), (Specialization)cbSpec.getSelectedItem());
                    int id = SPECIALIST_HANDLER.insertSpecialist(SP);
                    frame.dispose();
                }
                else
