...
public class ComprehensiveRegistration extends JFrame  {
private static final PatientsHandler PATIENTS_HANDLER = new PatientsHandler();
    public ComprehensiveRegistration() throws HeadlessException {
    ...
    private void createGui() {
        ...
        JFrame frame = new JFrame("Comprehensive Registration Form");
    ...
    private void addComponents(JFrame frame) {
        ...
        JTextField txtPager = new JTextField();
        c.gridx = 0;
        c.gridy = 11;
